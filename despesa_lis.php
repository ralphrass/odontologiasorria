...
<table width="100%" border="0" class="tabela_lista">
  ...
  <tr>
    ...
    <td class="tabela_linha"><select name="f_tp_fluxo" id="f_tp_fluxo">
      ...
      <option value="R" <?php if (isset($_POST['f_tp_fluxo']) && $_POST['f_tp_fluxo'] == 'R') echo "selected=\"selected\""; ?>>Receita</option>
      <option value="D" <?php if (isset($_POST['f_tp_fluxo']) && ($_POST['f_tp_fluxo'] == 'D' || $_POST['f_tp_fluxo'] == '') || !isset($_POST['f_tp_fluxo'])) echo "selected=\"selected\""; ?>>Despesa</option>
    </select></td>
