...
<table width="100%" border="0">
  <tr>
    <td colspan="2" bgcolor="#e8eefa" style="font-size:18px" id="cabecalho"><font style="color:black; font-weight:bold">Cl&iacute;nica Sorria - Vers&atilde;o 1.2</font></td>
  </tr>
  <tr style="vertical-align:top">
    ...
    <table width="100%" border="0" style="vertical-align:top; background-color:#EEEEEE">
      ...
      <tr>
        <td class="menu_divisao" style="border-top:solid 1px;"><div align="center"><img src="img/clientes.png" width="52" height="52" onclick="seta_tela('cli');" /></div>
	  ...
	  ?>
      <tr>
        <td class="menu_divisao"><div align="center"><img src="img/usuario.png" width="52" height="52" onclick="seta_tela('usu');" /></div>
          <div align="center" class="menu_label">Usu&aacute;rios</div></td>
      </tr>
      <?php } ?>
      <tr>
        <td class="menu_divisao"><div align="center"><img src="img/renda.png" width="52" height="52" onclick="seta_tela('ren');" /></div>
          <div align="center" class="menu_label">Receita</div></td>
      </tr>
      <tr>
        <td class="menu_divisao"><div align="center"><img src="img/gastos.png" width="52" height="52" onclick="seta_tela('des');" /></div>
          <div align="center" class="menu_label">Despesa</div></td>
      </tr>
      <tr>
        <td class="menu_divisao"><div align="center"><img src="img/cheque.png" width="52" height="52" onclick="seta_tela('che');" /></div>
	  ...
	  ?>
      <tr>
        <td class="menu_divisao"><div align="center"><img src="img/tipo_material.png" width="52" height="52" onclick="seta_tela('mat');" /></div>
          <div align="center" class="menu_label">Tipo Material</div></td>
      </tr>
      <?php } ?>
      <tr>
        <td class="menu_divisao"><div align="center"><img src="img/estoque.png" width="52" height="52" onclick="seta_tela('est');" /></div>
	  ...
	  ?>
      <tr>
        <td class="menu_divisao"><div align="center"><img src="img/relatorio.png" width="52" height="52" onclick="seta_tela('rel');" /></div>
    ...
    <table width="287" border="0" cellpadding="0" cellspacing="0">
      <tr>
        <td width="57"><img src="img/novo.png" width="52" height="52" onclick="seta_acao('cad');" alt="Novo" title="Novo" /></td>
        <td width="57"><img src="img/save.png" width="52" height="52" onclick="seta_acao('sal');" alt="Salvar" title="Salvar"  /></td>
        <td width="58"><img src="img/lista.png" width="52" height="52" onclick="seta_acao('lis');" alt="Lista" title="Lista"  /></td>
        <td width="57"><img src="img/excluir.png" width="52" height="52" onclick="seta_acao('exc');" alt="Excluir" title="Excluir"  /></td>
        <td width="58"><img src="img/pesquisar.png" width="52" height="52" onclick="seta_acao('pes');" alt="Pesquisar" title="Pesquisar"  /></td>
        <td width="58"><img src="img/imprimir.png" width="52" height="52" onclick="seta_acao('imp');" alt="Imprimir" title="Imprimir"  /></td>
      </tr>
    </table>
    </td>
  </tr>
