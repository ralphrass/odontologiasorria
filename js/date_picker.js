...
var dayArrayShort = new Array('Do', 'Se', 'Te', 'Qu', 'Qi', 'Se', 'Sa');
...
var monthArrayLong = new Array('Janeiro', 'Fevereiro', 'Marco', 'Abril', 'Maio', 'Junho', 'Julho', 'Agosto', 'Setembro', 'Outubro', 'Novembro', 'Dezembro');
...
function refreshDatePicker(dateFieldName, year, month, day)
{
  ...
  html += "<button class='dpTodayButton' onClick='updateDateField(\"" + dateFieldName + "\");'>fecha</button>";
  html += xTD + xTR;
